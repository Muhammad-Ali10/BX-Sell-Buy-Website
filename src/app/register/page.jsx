...
import { User, Mail, Lock, Star, ChevronLeft, ChevronRight } from "lucide-react"
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 md:p-5 lg:p-10">
        <div className="w-full max-w-md">
          ...
          <form className="space-y-4">
            ...
            <button type="submit" className="w-full py-3 bg-[#C5FD1F] text-black !text-base text-black font-normal !font-sora rounded-full">
              Create Account
            </button>
          </form>
          ...
          <div className="flex justify-center mt-8">
            <div className="w-12 h-1 bg-blue-600 rounded-full mr-1"></div>
            <div className="w-12 h-1 bg-gray-200 rounded-full mr-1"></div>
